...
if ($action == 'create_invoice'){
    ...
    // Informasi pelanggan untuk faktur
    // Penagihan
    ...
    $customer_address_1 = mysqli_real_escape_string($mysqli, $_POST['customer_address_1']);
    $customer_address_2 = mysqli_real_escape_string($mysqli, $_POST['customer_address_2']);
    $customer_town = mysqli_real_escape_string($mysqli, $_POST['customer_town']);
    $customer_county = mysqli_real_escape_string($mysqli, $_POST['customer_county']);
    $customer_postcode = mysqli_real_escape_string($mysqli, $_POST['customer_postcode']);
    $customer_phone = mysqli_real_escape_string($mysqli, $_POST['customer_phone']);
    
    // Pengiriman
    $customer_name_ship = mysqli_real_escape_string($mysqli, $_POST['customer_name_ship']);
    $customer_address_1_ship = mysqli_real_escape_string($mysqli, $_POST['customer_address_1_ship']);
    $customer_address_2_ship = mysqli_real_escape_string($mysqli, $_POST['customer_address_2_ship']);
    $customer_town_ship = mysqli_real_escape_string($mysqli, $_POST['customer_town_ship']);
    $customer_county_ship = mysqli_real_escape_string($mysqli, $_POST['customer_county_ship']);
    $customer_postcode_ship = mysqli_real_escape_string($mysqli, $_POST['customer_postcode_ship']);
    ...
    $invoice_due_date = mysqli_real_escape_string($mysqli, $_POST['invoice_due_date']);
    $invoice_subtotal = floatval($_POST['invoice_subtotal']);
    $invoice_shipping = floatval($_POST['invoice_shipping']);
    $invoice_discount = floatval($_POST['invoice_discount']);
    $invoice_vat = floatval($_POST['invoice_vat']);
    $invoice_total = floatval($_POST['invoice_total']);
    $notes = mysqli_real_escape_string($mysqli, $_POST['notes']);
    $invoice_type = mysqli_real_escape_string($mysqli, $_POST['invoice_type']);
	$id_bayar = mysqli_real_escape_string($mysqli, $_POST['id_bayar']);
    ...
    $query = $mysqli->prepare("INSERT INTO invoices (invoice, custom_email, invoice_date, invoice_due_date, subtotal, shipping, discount, vat, total, notes, invoice_type, id_bayar, id_pegawai, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $query->bind_param("isssdddddsssss", $invoice_number, $custom_email, $invoice_date, $invoice_due_date, $invoice_subtotal, $invoice_shipping, $invoice_discount, $invoice_vat, $invoice_total, $notes, $invoice_type, $id_bayar, $id_pegawai, $invoice_status);
    
    if ($query->execute()) {
        $customer_query = $mysqli->prepare("INSERT INTO customers (invoice, name, email, address_1, address_2, town, county, postcode, phone, name_ship, address_1_ship, address_2_ship, town_ship, county_ship, postcode_ship) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $customer_query->bind_param("sssssssssssssss", $invoice_number, $customer_name, $customer_email, $customer_address_1, $customer_address_2, $customer_town, $customer_county, $customer_postcode, $customer_phone, $customer_name_ship, $customer_address_1_ship, $customer_address_2_ship, $customer_town_ship, $customer_county_ship, $customer_postcode_ship);
